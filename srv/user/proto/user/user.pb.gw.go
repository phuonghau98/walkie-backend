...
var (
	pattern_UserService_Authenticate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user", "authenticate"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_UserService_GetUserProfile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user", "getprofile"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_UserService_GetAllUsers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user", "userlist"}, "", runtime.AssumeColonVerbOpt(true)))
)
